...
public class BookControllerAccessTest {
    ...
    public static Stream<Arguments> getTestData() {
        ...
        return Stream.of(
                Arguments.of("get", "/", "user", roles, 200),
                Arguments.of("get", "/", null, null, 302),
                Arguments.of("get", "/edit/book", "user", roles, 200),
                Arguments.of("get", "/edit/book", null, null, 302),
                Arguments.of("post", "/edit/book", "user", roles, 200),
                Arguments.of("post", "/edit/book", null, null, 302),
                Arguments.of("get", "/add/book", "user", roles, 200),
                Arguments.of("get", "/add/book", null, null, 302),
                Arguments.of("delete", "/delete/book", "user", roles, 200),
